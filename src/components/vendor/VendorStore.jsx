...
const VendorStore = () => {
  ...
  useEffect(() => {
    const fetchStoreData = () => {
      try {
        ...
        const vendorInfo = {
          id: storeProducts[0].vendorId,
          name: storeProducts[0].businessName || storeProducts[0].vendorName, // Use businessName with fallback
          storeSlug: storeProducts[0].vendorSlug,
        };

        setVendorStore(vendorInfo);
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 text-center">
        <div className="bg-white p-8 rounded-lg shadow-sm">
          ...
          <p className="mt-2 text-gray-600">
            Sorry, we couldn't find the vendor store you're looking for.
          </p>
          <Link
            to="/"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="text-center sm:text-left">
            <h1 className="text-2xl sm:text-2xl font-bold text-gray-900">
              Welcome to {vendorStore?.name || "Our Store"}
            </h1>
            <p className="mt-2 text-gray-600">
              Discover our amazing products, selected for quality and value
            </p>
          </div>
      ...
      {/* Cleaner, Professional Footer */}
      <div className="bg-white mt-8 border-t">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <div className="mb-4 sm:mb-0">
              <p className="text-sm text-gray-600">
                This is an official vendor store on{" "}
            ...
            <div>
              <p className="text-sm text-gray-500">
                © {new Date().getFullYear()} Kasoowa FoodHub. All rights
                reserved.
              </p>
            </div>
          </div>
